        ...
        <div class="seccion-noticia">
            ...
            <div class="panel panel-primary">
                <div class="panel-heading">
                  <h2 class="panel-title">Eventos más recientes</h2>
                </div>
                <div class="panel-body">
                    ...
                    try {
                        String sql = "select * from evento order by fecha_publicacion desc limit " + (pages-1)*perPage + ", " + perPage ;
                                ...
                                <div class="row">
                                    <div class="page-header">
                                        <h1 style="margin-left: 20px;"><%= rs.getString("titulo")%> &nbsp; 
                                            <small class="pull-right" style="padding-right: 10px;font-size: 15px; font-family: 'Open Sans'">
                                    ...
                                    <div class="col-xs-4 col-md-5">
                                        <a href="detalle-evento.jsp?id=<%= rs.getString("id")%>" class="thumbnail">
                                          <img src="img/eventos/<%= rs.getString("path")%>" alt="">
                                        </a>
                                    </div>
                                    <div class="col-xs-7">
                                        <p class="descr">
                                        ...
                                        <a href="detalle-evento.jsp?id=<%= rs.getString("id")%>" class="btn btn-primary">Leer más...</a>
                                    </div>                                    
                                </div>                            
                            </div>                                                        
                        </div> 
            ...
            <nav aria-label="...">
                <ul class="pager">
                    <li class="previous"><a href="eventos.jsp?page=<%=pages-1%>"><i class="fa fa-angle-left"></i> &nbsp; Anterior</a></li>
                    <li class="next"><a href="eventos.jsp?page=<%=pages+1%>">Siguiente &nbsp; <i class="fa fa-angle-right"></i></a></li>
                </ul>
              </nav>
        </div>
